...
def export_users(generate=False):
    """
    Export users from users.csv to new_users.csv

    Args:
        generate (bool): If True, generates new_users.csv file. If False, only previews.
    """
    ...
    try:
        ...
        print(f"\nUsers DataFrame shape: {df_filtered.shape}")
